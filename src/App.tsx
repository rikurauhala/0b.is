...
import { ConvertModeType } from './types/types';

const App = (): JSX.Element => {
  const [input, setInput] = useState<string>('');
  const [darkMode, setDarkMode] = useState<boolean>(true);
  const [converterMode, setConverterMode] = useState<ConvertModeType>('BinToDec');
  ...
  const handleConverterModeChange = (mode: ConvertModeType): void => {
